...
function createStoryJS(c, src) {
	var storyjs_embedjs, t, te, x, isCDN = false,
		...
		path = {
			base: embed_path,
			css: "/packages/agnito_timeline/css/",
			js: "/packages/agnito_timeline/js/",
			locale: "/js/locale/",
	...
	if (storyjs_e_config.js.match("locale")) {
		...
		storyjs_e_config.js = path.js + "timeline-min.js"
	}
	if (storyjs_e_config.js.match("/")) {} else {
		storyjs_e_config.css = path.css + storyjs_e_config.type + ".css";
		storyjs_e_config.js = path.js + storyjs_e_config.type;
		if (storyjs_e_config.debug) {
			storyjs_e_config.js += ".js"
		} else {
			storyjs_e_config.js += "-min.js"
		}
	...
	if (storyjs_e_config.lang.match("/")) {
		...
		path.locale = path.locale + storyjs_e_config.lang + ".js"
	}
	createEmbedDiv();
	...
	if (storyjs_e_config.font == "default") {
		...
		if (storyjs_e_config.font.match("/")) {
			...
			path.font.css = path.font.css + storyjs_e_config.font + ".css"
		}
...
this.createStoryJS = createStoryJS